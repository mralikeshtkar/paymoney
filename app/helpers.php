...
if (! function_exists('getPaymoneySettings')) {
    ...
    function getPaymoneySettings($type = null)
    {
        ...
        if (module('Investment')) {
            ...
            $array['transaction_types']['mobile']['sent']['Investment'] = Investment;
        }
...
if (!function_exists('userImageUrl')) {
    /**
     * userImageUrl
     *
    ...
    {
        return !empty($image) && file_exists(public_path('user_dashboard/profile/' . $image))
            ? asset('public/user_dashboard/profile/' . $image)
            : asset('public/user_dashboard/images/avatar.jpg');
    }
}

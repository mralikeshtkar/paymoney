...
class UserTransactionController extends Controller
{
    ...
    public function getTransaction(Request $request)
    {
        ...
        if (module('BlockIo') && !empty($transaction->cryptoAssetApiLog)) {
            $getCryptoDetails = (new \Modules\BlockIo\Classes\BlockIo)->getCryptoPayloadConfirmationsDetails($transaction->transaction_type_id, optional($transaction->cryptoAssetApiLog)->payload, optional($transaction->cryptoAssetApiLog)->confirmations);
            ...
            switch ($transaction->transaction_type_id) {
                case Deposit:
                    if (optional($transaction->payment_method)->name == 'Mts') {
                        ...
                        $pm = optional($transaction->payment_method)->name;
                    }
                    $data['html'] ="<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div> <p>" . __('Deposited To') . "</p></div>" .
                                    ...
                                    "<div class='d-flex justify-content-between flex-wrap  mt-4'>" .
                                        "<div> <p>" . __('Deposited Amount') . "</p></div>" .
                    ...
                    $data['total'] =  "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>". __('Deposited Amount') . "</h2>
                                        ...
                                        "<div class='form-group mt-5 text-center'>" .
                                            "<a href='" . url('deposit-money/print/' . $transaction->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a>" .
                                        "</div>";
                    break;
                ...
                case Withdrawal:
                    ...
                    $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div><p>" . __('Withdrawal With') . "</p></div>" .
                                        "<div><p>" . $pm . "</p></div>" .
                                    "</div>" .
                                    "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div><p>" . __('Transaction ID') . "</p></div>" .
                                    ...
                                    "<h4  class='text-18 mt-4 font-weight-600'>" . __('details') . "</h4>" .
                                    "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div> <p>" . __('Withdrawal Amount') . "</p></div>" .
                    ...
                    $data['total'] =  "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" . __('Withdrawal Amount') . "</h2>
                                            <h1 class='text-white mt-4'><strong>" . moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->subtotal, $transaction->currency_id)) . "</strong></h1>
                                        </div>" .

                                        "<h4 class='mt-2 text-center text-white text-16'>". $transaction->created_at->format('jS F Y') . "</h4>" .
                                        "<div class='form-group mt-5 text-center'>" .
                                            "<a href='" . url('withdrawal-money/print/' . $transaction->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a> &nbsp;&nbsp;" .
                                        "</div>";
                ...
                case Transferred:
                    ...
                    if (isset($transaction->email) && ($transaction->user_type == 'registered')) {
                        $receiverEmailorPhone = optional($transaction->end_user)->email;
                        $receiverName = getColumnValue($transaction->transfer->receiver);
                    } else if (isset($transaction->phone) && ($transaction->user_type == 'registered')) {
                        $receiverEmailorPhone = optional($transaction->end_user)->formattedPhone;
                        $receiverName = getColumnValue($transaction->transfer->receiver);
                    }
                    ...
                    $data['html'] = $unregisteredEmailOrPhone .
                                    ...
                                    "<div class='d-flex justify-content-between flex-wrap mt-4'>" .
                                        "<div><p>" . __('Transferred Amount') .  "</p></div>" .
                                        "<div><p>" . moneyFormat(optional($transaction->currency)->symbol, formatNumber(abs($transaction->subtotal), $transaction->currency_id)) . "</p></div>" .
                                    "</div>";
                    ...
                    if ($fee > 0) {
                        $data['html'] .= "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        ...
                                        "<h4 class='text-16 mt-4 font-weight-600'>" . __('Note') . "</h4>" .
                    ...
                    $data['total'] =  "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" . __('Transferred Amount') . "</h2>
                                            <h1 class='text-white mt-4'><strong>" . moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->subtotal, $transaction->currency_id)) . "</strong></h1>
                                        </div>" .

                                        "<h4 class='mt-2 text-center text-white text-16'>". $transaction->created_at->format('jS F Y') . "</h4>" .
                                        "<div class='form-group mt-5 text-center'>" .
                                            "<a href='" . url('moneytransfer/print/' . $transaction->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a> &nbsp;&nbsp;" .
                                        "</div>";
                    break;
                ...
                case Received:
                    ...
                    if (isset($transaction->email)) {
                        $senderEmailOrPhone = optional($transaction->end_user)->email;
                    } else if (isset($transaction->phone)) {
                        $senderEmailOrPhone = optional($transaction->end_user)->formattedPhone;
                    }

                    $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div><p>" . __('Received From') . "</p></div>" .
                                        "<div><p>" . getColumnValue($transaction->transfer->sender) . " <strong>(" . $senderEmailOrPhone . ")</strong>" . "</p></div>" .
                                    "</div>" .
                                    ...
                                    "<h4 class='mt-4'>". __('details') ."</h4>".

                                    "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div><p>" . __('Received Amount') .  "</p></div>" .
                                        "<div><p>" . moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->subtotal, $transaction->currency_id)) . "</p></div>" .
                                    "</div>" .
                                    "<hr>".
                ...
                case Exchange_From:
                    $data['html'] ="<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                    ...
                                    "<div class='d-flex justify-content-between flex-wrap mt-4'>" .
                                        "<div><p>" . __('Exchange Amount') . "</p></div>" .
                    ...
                    if ($fee > 0) {
                        $data['html'] .=    "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                            ...
                                            "<hr class='mt-0 mb-2'>" .
                                            "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                                "<div><h4 class='text-16 font-weight-600'>" . __('Total') . "</h4></div>" .
                    ...
                    $data['total'] =  "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" .  __('Exchange From') . "</h2>
                                            <h1 class='text-white mt-4'><strong>" . moneyFormat(optional($transaction->currency)->symbol, formatNumber(abs($transaction->subtotal))) . "</strong></h1>
                                        </div>" .

                                        "<h4 class='mt-4 text-center text-white text-16'>". $transaction->created_at->format('jS F Y') . "</h4>" .
                                        "<div class='form-group mt-5 text-center'>" .
                                            "<a href='" . url('transactions/exchangeTransactionPrintPdf/' . $transaction->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a> &nbsp;&nbsp;" .
                                        "</div>";
                    break;

                case Exchange_To:
                    $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div><p>" . __('To Wallet') . "<p></div>" .
                                        "<div><p>" . optional($transaction->currency)->code . "</p></div>" .
                                    "</div>" .
                    ...
                    $data['total'] =  "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" . __('Exchange Amount') . "</h2>
                ...
                case Request_From:
                    ...
                    if ($transaction->status == 'Pending') {
                        $cancel_btn = "<button class='btn btn-cancel mt-4 btn-sm trxnreqfrom' data-notificationType='{$conditionForRequestToPhoneAndEMail}' data='{$transaction->id}' data-type='{$transaction->transaction_type_id}' id='btn_{$transaction->id}'>" . __('Cancel') . "</button>";
                    }
                    if ($transaction->user_type == 'registered') {
                        $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                            "<div><p>" . __('Requested To') . "</p></div>" .
                                            "<div><p>" . getColumnValue($transaction->end_user) . '<strong> (' . (! empty($transaction->email) ? $transaction->email : $transaction->phone) . ')</strong>' ."</p></div>" .
                                        "</div>";
                    } else {
                        if (! empty($transaction->email)) {
                            $data['html'] ="<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                    ...
                    $data['html'] .="<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                    ...
                                    "<div class='d-flex justify-content-between flex-wrap mt-4'>" .
                                        "<div><p>".__('Requested Amount') ."</p> </div>" .
                                        "<div><p>" . moneyFormat(optional($transaction->currency)->symbol, formatNumber(abs($transaction->subtotal), $transaction->currency_id)) . "</p></div>" .
                                    "</div>" .
                    ...
                    $data['total'] =    "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" . __('Requested Amount') . "</h2>
                                            <h1 class='text-white mt-4'><strong>". moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->total, $transaction->currency_id)) . "</strong></h1>
                                        </div>" .

                                        "<h4 class='mt-2 text-center text-white text-16'>". $transaction->created_at->format('jS F Y') . "</h4>" .
                                        "<div class='form-group mt-5 text-center'>" .
                                            "<a href='" . url('request-payment/print/' . $transaction->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a> &nbsp;&nbsp;" .
                                        "</div>";
                    break;
                ...
                case Request_To:
                    ...
                    if ($transaction->status == 'Pending') {
                        ...
                        id='btn_{$transaction->id}'>" . __('Cancel') . "</button>";

                        $twoButtons .= " <button class='btn btn-primary ml-2 mt-4 btn-sm trxn_accept' data-rel='" . $transaction->transaction_reference_id . "' data='" . $transaction->id . "' id='acceptbtn_" . $transaction->id . "'> " . __('Accept') . " </button>";
                    }

                    if ($transaction->user_type == 'registered') {
                        $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                            "<div><p>" . __('Requested From') . "</p></div>" .
                                            "<div><p>" . getColumnValue($transaction->end_user) . ' <strong>(' . (! empty($transaction->email) ? optional($transaction->end_user)->email : optional($transaction->end_user)->formattedPhone) . ')</strong>' ."</p></div>" .
                                        "</div>";
                    } else {
                        $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                            "<div class='text-16 font-weight-600'>" . __('Email')  . "</div>" .
                                            "<div>" . $transaction->email ."</div>" .
                                        "</div>";
                    }
                    $data['html'] .= "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div class='text-16 font-weight-600'>" . __('Transaction ID') . "</div>" .
                    ...
                    if ($fee > 0) {
                        ...
                        $data['html'] .= "<hr class='mt-0 mb-2'>" .
                                        "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                            "<div class='text-16 font-weight-600'>" . __('Total') .   "</div>" .
                ...
                case Payment_Sent:
                    $data['html'] = "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div><p>" . __('Merchant') . "</p></div>" .
                                        "<div><p>" . optional($transaction->merchant)->business_name . "</p></div>" .
                                    "</div>" .
                    ...
                    $data['total'] =  "<div class='text-center'>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" . __('Payment Amount')  . "</h2>
                                        ...
                                        "<h4 class='mt-2 text-center text-white text-16'>". $transaction->created_at->format('jS F Y') . "</h4>" .
                                        "<div class='form-group mt-5 text-center'>" .
                                            "<a href='" . url('transactions/merchant-payment-print/' . $transaction->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a> &nbsp;&nbsp;" .
                                        "</div>";
                    break;
                ...
                case Payment_Received:
                    ...
                    if ($fee > 0) {
                        ...
                        $data['total'] =  "<div class='text-center '>
                                                <h2 class='text-white text-center font-weight-700 text-20'>" . __('Payment Amount')  . "</h2>
                                                <h1 class='text-white mt-2'><strong>". moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->subtotal)) . "</strong></h1>
                                            </div>" .
                ...
                case (module('CryptoExchange') ? Crypto_Swap : false):
                    ...
                    if (isActive('CryptoExchange')) {
                        ...
                        $data['total'] .= "<div class='form-group mt-5 text-center'>" .
                                                "<a href='" . url('crypto-buy-sell/print/' . optional($transaction->crypto_exchange)->id) . "' target='_blank' class='btn btn-light pl-4 pr-4 btn-sm'>" . __('Print') . "</a> &nbsp;&nbsp;" .
                                        "</div>";
                    }

...
class AcceptMoneyService
{
    ...
    {
        $currencyFee = $this->helper->transactionFees($currencyId, $amount, Request_To);
    ...
    {
        try {
            $transaction_type  = $transaction->transaction_type_id == Request_To ? Request_From : Request_To;
            Transaction::where([

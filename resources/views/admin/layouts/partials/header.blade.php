<header class="main-header">
    ...
    <a href="{{ route('dashboard') }}" class="logo pt-12 text-decoration-none">
        ...
        @if (!empty($company_logo))
            <img src="{{ url('images/logos/'.$company_logo) }}" width="192" height="49" class="company-logo">
        @else
            <img src="{{ url('uploads/userPic/default-logo.jpg') }}" width="192" height="49" class="company-logo">
        @endif
    </a>
    </div>

		...
		<div class="col-md-9">
			<div class="box box-info">
				<div class="box-header with-border text-center">
					<h3 class="box-title">
						@if($list_menu == 'twoCheckout'){{ ucwords(str_replace('two', '2', $list_menu)) }} {{ __('Settings') }}
						@elseif($list_menu == 'bank')
						@elseif($list_menu == 'cash')
						{{ "Cash Payment" }} {{ __('Settings') }}
						@elseif($list_menu == 'mobile')
						{{ "Mobile Payment" }} {{ __('Settings') }}
						@else{{ ucfirst($list_menu) }} {{ __('Settings') }}
						@endif
					</h3>
				</div>
					...
					<div class="box-body">
						...
						@if($list_menu == 'stripe')
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="{{ __('Stripe Processing Time') }}"
							...
							<!-- Stripe - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="stripe_status">{{ __('Status') }}</label>
								<div class="col-sm-5">
									<select class="form-control" name="stripe_status" id="stripe_status">
										<option value=''>{{ __('Select Status') }}</option>
										<option value='Active' {{ isset($currencyPaymentMethod->activated_for) && $currencyPaymentMethod->activated_for == json_encode(['deposit' => '']) ? 'selected':"" }}>{{ __('Active') }}</option>
										<option value='Inactive' {{isset($currencyPaymentMethod->activated_for) &&  $currencyPaymentMethod->activated_for == json_encode(['' => '']) ? 'selected':"" }}>{{ __('Inactive') }}</option>
									</select>
								</div>
							</div>
							<div class="clearfix"></div>
						...
						@elseif ($list_menu == 'paypal')
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">{{ __('Processing Time (days)') }}</label>
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="{{ __('PayPal Processing Time') }}"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- paypal - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="paypal_status">{{ __('Status') }}</label>
								<div class="col-sm-5">
						...
						@elseif ($list_menu == 'twoCheckout')
							<!-- 2Checkout - Seller ID -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="twoCheckout[seller_id]">{{ __('Seller ID') }}</label>
								<div class="col-sm-5">
									<input class="form-control" name="twoCheckout[seller_id]" type="text" placeholder="{{ __('2Checkout Seller ID') }}"
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">{{ __('Processing Time (days)') }}</label>
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="{{ __('2Checkout Processing Time') }}"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- 2Checkout - Mode -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="twoCheckout[mode]">{{ __('Mode') }}</label>
								<div class="col-sm-5">
							...
							<!-- twoCheckout - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="twoCheckout_status">{{ __('Status') }}</label>
								<div class="col-sm-5">
						...
						@elseif ($list_menu == 'payUMoney')
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">{{ __('Processing Time (days)') }}</label>
								<div class="col-sm-5">
									<input class="form-control processing_time" name="processing_time" type="text" placeholder="{{ __('PayUMoney Processing Time') }}"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- payUMoney - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="payUMoney_status">{{ __('Status') }}</label>
								<div class="col-sm-5">
						...
						@elseif ($list_menu == 'coinPayments')
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">{{ __('Processing Time (days)') }}</label>
								<div class="col-sm-5">
									<input class="form-control processing_time" name="processing_time" type="text" placeholder="{{ __('CoinPayments Processing Time') }}"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- coinPayments - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="coinPayments_status">{{ __('Status') }}</label>
								<div class="col-sm-5">
						...
						@elseif ($list_menu == 'Payeer')
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input class="form-control payeer[merchant_domain]" name="payeer[merchant_domain]" type="text" placeholder="{{ __('Payeer Merchant Domain') }}"
								...
								<div class="col-sm-4">
									<p>{{ __('only latin letters, digits and hyphen') }}</p>
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">{{ __('Processing Time (days)') }}</label>
								<div class="col-sm-5">
									<input class="form-control processing_time" name="processing_time" type="text" placeholder="{{ __('Payeer Processing Time') }}"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- Payeer - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="payeer_status">{{ __('Status') }}</label>
								<div class="col-sm-5">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<button data-toggle="modal" data-target="#addModal" id="addBtn" class="btn btn-theme pull-left bank-modal" type="button">
						...
						<div class="modal-content">
							...
							<form id="add-bank" method="post" enctype="multipart/form-data">
								...
								<div class="modal-body">
									<div class="row">
										<div class="col-md-12 mod-position">
			        ...
			        $.each(data.banks, function(key, value)
			        {
			        	// console.log(value);
			          	tr += 	'<tr>'+
				                  	...
				                  	'<td>'+
					                  	'<a data-id="'+value.id+'" class="btn btn-xs btn-primary edit-setting"><i class="fa fa-edit"></i></a> '+

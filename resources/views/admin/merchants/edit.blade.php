	...
	<div class="box">
		<div class="panel-body ml-20">
			<ul class="nav nav-tabs f-14 cus" role="tablist">
				<li class="nav-item">
				    <a class="nav-link active" href='{{ url(\Config::get('adminPrefix')."/merchant/edit/$merchant->id")}}'>{{ __('Profile') }}</a>
				</li>

				<li class="nav-item">
				    <a class="nav-link" href="{{ url(\Config::get('adminPrefix')."/merchant/payments/$merchant->id")}}">{{ __('Payments') }}</a>
				</li>
			</ul>
							...
							<div class="col-md-12 mt-1">
								@if ($merchant->user)
									<div class="form-group row">
										<label class="control-label col-sm-3 mt-11 text-sm-end fw-bold f-14" for="user">{{ __('User') }}</label>
										<div class="col-sm-6">
											<p class="form-control-static mb-0 f-14">{{ isset($merchant->user) ? $merchant->user->first_name.' '.$merchant->user->last_name :"-" }}</p>
										</div>
									</div>
								@endif
								...
								@if ($merchant->merchant_uuid)
									<div class="form-group row">
										<label class="control-label col-sm-3 mt-11 text-sm-end fw-bold f-14" for="merchant_uuid">{{ __('Merchant ID') }}</label>
										<div class="col-sm-6">
								...
								@if ($merchant->business_name)
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control f-14" name="business_name" value="{{ $merchant->business_name }}">
								...
								@if ($merchant->site_url)
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control f-14" name="site_url" value="{{ $merchant->site_url }}">
								...
								@if ($merchant->currency_id)
									<div class="form-group row">
										<label class="control-label col-sm-3 mt-11 text-sm-end fw-bold f-14" for="site_url">{{ __('Currency') }}</label>
										<div class="col-sm-6">
							...
							<div class="col-md-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 d-flex">
                                        <div>
                                            <a id="cancel_anchor" class="btn btn-theme-danger f-14 me-2" href="{{ url(\Config::get('adminPrefix').'/merchants') }}">{{ __('Cancel') }}</a>
                                        </div>

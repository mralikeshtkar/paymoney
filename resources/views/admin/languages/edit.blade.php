  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        ...
        <!-- form start -->
        <form method="POST" action="{{ url(\Config::get('adminPrefix').'/settings/edit_language/'.$result->id) }}" class="form-horizontal" enctype="multipart/form-data" id="edit_language_form">
          {{ csrf_field() }}
          ...
          <div class="box-body">
            <div class="form-group row">
              <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end" for="name">Name</label>
              <div class="col-sm-6">
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-3 control-label f-14 fw-bold text-end">{{ __('Flag') }}</label>
              <div class="col-sm-6">
